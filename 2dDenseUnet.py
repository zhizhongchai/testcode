...
def __create_dense_net(nb_classes, img_input, include_top, depth=40, nb_dense_block=3, growth_rate=12, nb_filter=-1,
    ...
    # x = Conv2D(1, 1, activation='relu', padding='same', kernel_initializer='he_normal')(conv10)
...
if __name__ == '__main__':
    ...
    model = DenseNetImageNet161(input_shape=(224, 224, 3),
                                bottleneck=True,
                                reduction=0.5,
                                dropout_rate=0.0,
                                weight_decay=1e-4,
    ...
    checkpoint = ModelCheckpoint(filepath='models/weights.{epoch:02d}-{val_loss:.5f}.{epoch:02d}-{val_acc:.5f}.h5', verbose=1,
                                 save_best_only=True)
