...
if __name__ == '__main__':
    ...
    checkpoint = ModelCheckpoint(filepath='models/weights.{epoch:02d}-{val_loss:.5f}.h5', verbose=1,
                                 save_best_only=True)
    model.fit_generator(generator=generate_arrays(4, 'train.txt'), steps_per_epoch=2500,
                        epochs=20,
                        verbose=1,
                        callbacks=[checkpoint],
                        validation_data=generate_arrays(2, 'val.txt'),
